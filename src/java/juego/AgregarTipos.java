 ...
 */
@WebServlet(name = "AgregarTipos", urlPatterns = {"/AgregarTipos"})
public class AgregarTipos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            tipos.setDescripcion((String) request.getParameter("tipo").toUpperCase());
            controlTipo.create(tipos);
